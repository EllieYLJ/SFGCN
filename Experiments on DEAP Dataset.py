...
class gcn1(torch.nn.Module):
    def __init__(self, n):
        ...
        self.mlp = torch.nn.Linear(32 * 32 * 3, 32)  ######！！！！！！！deap=32，dreamer=14
...
for l in label_list:
    label_suffix = l
    if l == ".mat_labelD.pkl":
        file_list = ['s01', 's02', 's03', 's04', 's05', 's06', 's07', 's08', 's09', 's10', 's11', 's12', 's13', 's14',
                     's15', 's16', 's17', 's18', 's19', 's20', 's21', 's22', 's23', 's24', 's25', 's26', 's28', 's29',
                     's30', 's31', 's32']
